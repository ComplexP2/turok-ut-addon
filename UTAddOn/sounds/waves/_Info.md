...
The intended sound files to use are the "female voice" from "Unreal Tournament 2003/2004". The names of all currently implemented sound files are listed in [Original UT Sound files](#original-ut-sound-files).
...
You may want to look at `<root>\UTAddOn\_tools_python\wav_durations.txt` to check audio durations of these (and other) files.